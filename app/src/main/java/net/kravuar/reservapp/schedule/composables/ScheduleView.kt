...
@Composable
fun ScheduleView(schedule: SortedMap<LocalDate, List<Pair<Staff, ReservationSlot>>>, onReserve: () -> Unit) {
    LazyColumn(
...
@Composable
fun DaySchedule(date: LocalDate, reservations: List<Pair<Staff, ReservationSlot>>, onReserve: () -> Unit) {
    Card(
