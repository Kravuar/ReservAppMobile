...
interface ScheduleTemplate {
    ...
    suspend fun getScheduleByService(@Path("serviceId") serviceId: Long, @Path("from") from: LocalDate, @Path("to") to: LocalDate): Map<ScheduleStaff, NavigableMap<LocalDate, Set<ReservationSlot>>>
